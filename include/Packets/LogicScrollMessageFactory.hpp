/*
* LogicScrollMessageFactory.hpp - The SolarSCore
...
public:
	static int32_t sock; /* Socket */
	static char buffer[512]; /* Main buffer */
	static void createMessageByType(const uint16_t id); /* Creates Server-Side Message */
};
